...
generateBtn.addEventListener('click',()=>{
    ...
    //remove old password
    passsword="";
    //let us put the stuff mentioned by the checkboxes
    ...
    for(let i=0;i<passwordLength-funcArr.length;i++){
        ...
        passsword+=funcArr[randIndex]();
    }
    //shuffle the password
    passsword = shufflePassword(Array.from(passsword));
